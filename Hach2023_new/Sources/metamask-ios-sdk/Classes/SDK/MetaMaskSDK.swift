...
public class MetaMaskSDK: ObservableObject, SDKDelegate {
    ...
    // SocketClient(store: Keychain(service: SDKInfo.bundleIdentifier), tracker: Analytics(debug: true))
    convenience init(store: SecureStore = Keychain(service: SDKInfo.bundleIdentifier)) {
